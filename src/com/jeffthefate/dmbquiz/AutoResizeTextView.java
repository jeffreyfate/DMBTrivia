...
public class AutoResizeTextView extends TextView {
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (ApplicationEx.getTextSize() != 0.0f)
        	mTextSize = ApplicationEx.getTextSize();
        else
        */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    	//Log.i(Constants.LOG_TAG, "onLayout: " + changed + " : " + left + " : " + top + " : " + right + " : " + bottom + " : " + mNeedsResize);
    ...
    public void resizeText(int width, int height) {
        ...
        if (ApplicationEx.getTextViewHeight() != 0.0f) {
        	if (height > ApplicationEx.getTextViewHeight()) {
        		resizeText(width, (int) ApplicationEx.getTextViewHeight());
        		return;
        	}
        }
        */
        ...
        for (int i = 0; i < lines.length - mExtraTextLines; i++) {
        	sb.append(lines[i]);
        	sb.append("\n");
        }
        text = sb.toString();
        */
        ...
        while (textHeight > height && targetTextSize > mMinTextSize) {
            targetTextSize = Math.max(targetTextSize - 0.1f, mMinTextSize);
        ...
        ApplicationEx.setTextSize(targetTextSize);
        */
